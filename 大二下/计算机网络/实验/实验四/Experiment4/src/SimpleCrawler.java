...
//    // 需要爬的域名
//    private static String website="https://www.uooc.net.cn/league/union";
//    // 本地保存路径
//    private static final String SAVE_PATH = "D:/CrawlData/uooc";
//    // 需要下载的资源类型
//    private static final Set<String> ALLOWED_TYPES = Set.of("img", "script", "link", "a");
//
...
//        Document doc = Jsoup.parse(htmlFile, "UTF-8", website);
//
...
//        extractResources(doc, "a[href~=.pdf]", "href", resourceUrls); // 包含pdf的链接
//        extractResources(doc, "a[data-type=pdf]", "href", resourceUrls); // 匹配data-type属性
